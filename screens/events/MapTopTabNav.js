    ...
    render() {
        ...
        return (
            <Tab.Navigator tabBarOptions={{
                ...
                <Tab.Screen name="Eat" component={MapScreen} options={{ title: '飲食', tabBarLabel: '飲食', tabBarIcon: ({ tintColor }) => {<Icon source={require('../../image/shop.png')} size={24} />} }} initialParams={{ filter: "Eat" }}/>
