...
export default class SearchFavScreen extends React.Component {
    constructor(props) {
        super(props);
    ...
    async updateSearch(searchText) {
        ...
        if(searchText){
            ...
            for(var i=0; i<activities.length; i++){
                if(activities[i].name.includes(searchText)){
                    activitiesList = [ 
                        ...activitiesList, 
                        {
                            ...activities[i]
        ...
        this.setState({ activitiesList: activitiesList, loading: false, afterSearch: searchText });
    }
    ...
    render(){
        const { name } = this.props.route.params.activities;
